...
AWS.config.update({
  accessKeyId: "AKIARMDY4T5MQCRZX7I5", // fill in
  secretAccessKey: "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", // fill in
  region: "us-east-2", // fill in
});
